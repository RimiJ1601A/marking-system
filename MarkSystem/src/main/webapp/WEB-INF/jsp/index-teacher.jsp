                        ...
                        <div class="box box-solid">
                            ...
                            <div class="box-body" style="display: block;">
                                ...
                                <div class="chart">
                                    <!-- 被评次数 Chart Canvas -->
                                    <!-- 显示从系统启用到查询时的统计数据 -->
                                    <canvas id="teacherChart" style="height: 220px; width: 1071px;" height="220" width="1071"></canvas>
                                </div>
                                <!-- /.chart-responsive -->
                            </div>
                            <!-- /.box -->
            ...
            <div class="box-body">
              <ul class="products-list product-list-in-box">
                ...
                <li class="item">
                  ...
                  <div class="product-info">
                    <a href="javascript:void(0)" class="product-title">Web1701 <span class="label label-danger pull-right">2017-04</span></a>
                        <span class="product-description">
                          Web1701对你发起了评教.
                        </span>
                  </div>
