...
<meta
	...
	name="viewport">
<title>个人简介|Rimiedu_MSystem</title>
				...
				<div class="col-md-3">
					...
					<div class="box box-primary">
						...
						<div class="box-body box-profile">
							<!-- 更改用户头像 -->
							<button id="myuser-img" type="button" class="btn btn-default"
								data-target="#myModal" data-toggle="modal" data-placement="top"
								title="点击修改头像">
								<img id="profileUserImg" class="profile-user-img img-responsive img-circle"
									src="${sessionScope.user.headPhotoUrl}" alt="User profile picture">
							</button>
...
<!-- 							<li class="active"><a href="#timeline" data-toggle="tab">教育履历</a></li>
 ...
 -->							<li class="active"><a href="#setinfo" data-toggle="tab">修改信息</a></li>
	...
	<script type="text/javascript">
		...
		var fileName = $(".img_bg")[0].src.split("/")[$(".img_bg")[0].src
				.split("/").length - 1]; //选择上传的文件名
