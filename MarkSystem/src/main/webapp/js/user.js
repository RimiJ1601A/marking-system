...
//	var xsys = 6;// 页面显示多少页
//	var yuan;
//	var dqy = "<a aria-controls='example1' data-dt-idx='1' tabindex='0' href=user?dangqianye="+ dangqianye + "&value="+value+">" + dangqianye + "</a>";
//	$("#dqy").append(dqy);
//	for (var i = 1; i <= yeshu; i++) {
//		if (yeshu < xsys) {
//			if (i < dangqianye) {
//				yuan = "<a aria-controls='example1' data-dt-idx='" + i
//						+ "' tabindex='0' href=user?dangqianye=" + i +"&value="+value +">" + i
//						+ "</a>";
...
//		dangqianye = 1;
//	}
//	location.href = "user?dangqianye=" + dangqianye+"&value="+value;
//}
// 下一页
//function xyy() {
//	
...
function sousuo(){
	...
	if(value == null || value == ""){
		...
		location.href="user?value="+value+"&dangqianye=1";
	}
//	$.ajax({
//		type:"post",
//		url:"/selectUser",
